...
Interactive Chainlit chat interface implementing the complete 25-step DRIFT search methodology.
Provides visual step-by-step query execution with streaming responses.
"""
...
logging.basicConfig(
    ...
    handlers=[
        logging.FileHandler('logs/graphrag_query/chainlit_app.log', mode='a'),
